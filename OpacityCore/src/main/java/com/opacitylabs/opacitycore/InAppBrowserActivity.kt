...
class InAppBrowserActivity : AppCompatActivity() {
    ...
    private var instance_cookies: JSONObject = JSONObject()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        OpacityCore.getRuntime().webExtensionController.installBuiltIn("resource://android/assets/extension/").accept { ext ->
            if (ext != null) {
            ...
            object : WebExtension.MessageDelegate {
                override fun onMessage(
                    ...
                    instance_cookies = JsonUtils.mergeJsonObjects(instance_cookies, cookies)
    ...
    private fun handleNavigation(url: String) {
        ...
        val json =
            "{\"event\": \"navigation\"," +
                    "\"url\": \"$url\", \"cookies\": ${instance_cookies.toString()}, \"id\": \"${
